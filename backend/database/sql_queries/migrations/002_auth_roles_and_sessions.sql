...
CREATE TABLE IF NOT EXISTS Users_new (
    ...
    role varchar(20) NOT NULL DEFAULT 'user' CHECK (role IN ('user', 'admin', 'librarian')),
    phone varchar(15),
    email varchar(30),
...
INSERT OR IGNORE INTO schema_migrations(version) VALUES ('002_auth_roles_and_sessions');
